    ...
    cartDOM.insertAdjacentHTML(
      ...
      `
        <div class="cart-footer">
          ...
          <button class="btn btn-primary btn-small btn-danger" data-action="clear-cart" id="clear">Clear Cart</button>
          <button class="btn btn-primary btn-small btn-danger" data-action="checkout" id="checkout">Checkout</button>
        </div>
        `
    );
